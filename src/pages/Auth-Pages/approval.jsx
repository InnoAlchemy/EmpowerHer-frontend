...
import ApprovalImage from "../../assets/Approval.gif";
        ...
        <div className="max-w-md w-full">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <div className="flex justify-center md:justify-center mb-8">
              <img src={ApprovalImage} alt="Approval" className="w-44 h-44" />
            </div>

            <p className="text-center text-black font-cabin text-[20px] font-normal leading-[24.3px] whitespace-nowrap">
              Your account is under review. Please wait while our team carefully
              <br />
              reviews and completes the approval process.
            </p>
          </div>
