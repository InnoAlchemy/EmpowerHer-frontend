...
const SignUp = () => {
  ...
  return (
    <div className="relative w-full min-h-screen bg-white flex flex-col md:flex-row">
      ...
      <div className="w-full md:w-3/5 flex items-center justify-center bg-white">
        <div className="max-w-md w-full">
          ...
          <img
            src={logo}
            alt="Logo"
            className="absolute w-44 h-auto top-10 left-1/2 transform -translate-x-1/2 cursor-pointer md:left-4 md:top-10 md:transform-none"
          ...
          <div className="flex flex-col items-center mb-8 mt-18">
            <h2 className="text-3xl font-bold text-center text-[#7A89C2] mb-6">Sign Up Using</h2>
          ...
          <div className="w-full flex justify-center mt-6">
            <button
              ...
              className="w-1/2 h-12 flex items-center justify-center rounded-full border border-[#7A89C2] bg-white mx-auto"
            >
              <span className="text-[#7A89C2] font-cabin text-lg font-bold">Sign Up</span>
            </button>
          </div>
      ...
      <div className="w-full md:w-2/5 bg-[#7A89C2] flex flex-col items-center justify-start relative mt-6 md:mt-0 min-h-[calc(100vh-56px)]"> {/* Ensure the height is consistent */}
